...
import json
import mimetypes
from utils.renamer import rename_files_in_directory  # Import renaming function from utils module
...
def process_instagram_post(post_url):
    """
    Fetch media, download files, and rename them.
    """
    ...
    if isinstance(media_urls, list):
        ...
        # Rename files in the download directory
